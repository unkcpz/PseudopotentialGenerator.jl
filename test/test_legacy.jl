# Test for wrappers and legacy implementation translated from DFTATOM fortran code
...
@testset "ode1d - rk4" begin
    ...
    y0 = [1.0, 0.0]
    y1, y2, imax = DFTATOM_JL.rk4_integrate(mesh.r, y0, C1, C2, C1mid, C2mid, max_val)
    ...
    y0 = [1.0, 0.0]
    y1, y2, imax = DFTATOM_JL.rk4_integrate(f1, f2, mesh.r, y0, max_val)
    ...
    for l in [0, 1]
        for Z in [1, 1]
            for E in [-0.5]
                ...
                P_expect, Q_expect, imax_expect = FPGEN.schroed_outward_adams(l, Z, E, V, mesh.r, mesh.rp)
                ...
                P_expect, Q_expect, imin_expect = FPGEN.schroed_inward_adams(l, E, V, mesh.r, mesh.rp)
                P, Q, imin = DFTATOM_JL.schroed_inward_adams(l, E, V, mesh.r, mesh.rp)
...
@testset "rpoisson" begin
    ...
    vh = DFTATOM_JL.rpoisson_outward_pc(ρ, mesh.r, mesh.rp)
