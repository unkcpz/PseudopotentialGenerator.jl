...
#
#    #vh10 = rpoisson_outward_pc(ρ[1:10], mesh.r[1:10], mesh.rp[1:10])
#
#    #@test vh[1:10] ≈ vh10 atol = 1e-12
#    ρ = ρ[1:100]
#    r = mesh.r[1:100]
#    rp = mesh.rp[1:100]
#
#    vh = rpoisson_outward_pc(ρ, r, rp)
#    vh_std = poisson_outward(ρ, r, rp)
#
#    # compare the plots
#    using Plots
#
#    plot(mesh.r[1:100], vh, label="Expected")
#    plot!(mesh.r[1:100], vh_std, label="Standard Julia ODE solver")
#
#    savefig("poisson_outward.png")
#end
...
#
#mesh = Mesh(1e-7, 1.0, 1e2, 100)
#r = mesh.r
#rp = mesh.rp
#rp_u(idx) = rp[round(Int, idx)]
#function ff(u, p, t)
#    println("t: ", t)
#    du = 1.01 * u * rp_u(t)
#    du
#end
#y0 = 0.5 * exp(1.01 * 1e-7)
#
#prob = DiscreteProblem(ff, y0, (1, length(r)))
#sol = solve(prob, AB5(), dt=1, adaptive=false)
#
#
#plot!(r, sol.u, label="Exp grid")
#
#savefig("test.png")